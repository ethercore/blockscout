...
config :block_scout_web,
  ...
  show_percentage: if(System.get_env("SHOW_ADDRESS_MARKETCAP_PERCENTAGE", "true") == "false", do: false, else: false),
...
config :block_scout_web, BlockScoutWeb.Chain,
  ...
  logo: System.get_env("LOGO") || "/images/ethercore_testnet_logo.svg",
