    ...
    test "with a verified contract address", %{conn: conn} do
      ...
      expected_result = [
        %{
          "Address" => to_string(contract.address_hash),
          "SourceCode" =>
            "/**\n* Submitted for verification at explorer.ethercore.org on #{contract.inserted_at}\n*/\n" <>
  ...
  describe "verify" do
    test "with an address that doesn't exist", %{conn: conn} do
      ...
      expected_result = %{
        "Address" => to_string(contract_address.hash),
        "SourceCode" =>
          "/**\n* Submitted for verification at explorer.ethercore.org on #{verified_contract.inserted_at}\n*/\n" <>
